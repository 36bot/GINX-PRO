...
run:
	@clear && echo "starting" && sudo ./bin/evilginx -p ./phishlets -t ./templates -c ./config

debug:
	@clear && echo "starting" && sudo ./bin/evilginx -developer -p ./phishlets -t ./templates -c ./config -debug
